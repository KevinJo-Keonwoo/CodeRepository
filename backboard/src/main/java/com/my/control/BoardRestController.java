...
//	@ResponseBody      //{} 내부의 변수 이름과 아래 메서드의 매개변수명은 동일해야만 함 currentPage = currentPage
	public ResultBean<PageBean<Board>> list(@PathVariable //int currentPage) { //매개변수를 PathVariable로 사용하겠다
											Optional<Integer> optCp){ //PathVariable이 없는 경우도 생각해야 함 여기서는 required못쓰기때문 
